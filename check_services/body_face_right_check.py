...
class BodyFaceRightCheck:
    ...
    def check_right(self, frame_shape, left_shoulder, right_shoulder, mid_head):
        ...
        if subtraction < 30 and mid_head_x < right_shoulder_x:
            return True
    ...
    def check(self, frame):
        ...
        is_right = self.check_right(frame_shape, left_shoulder, right_shoulder, mid_head)
